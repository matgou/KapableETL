 ...
 */
public class writeToJDBCETLTest 
    extends TestCase
{
    /**
     ...
     */
    public writeToJDBCETLTest( String testName )
    {
        super( testName );
    }
    ...
    {
        return new TestSuite( writeToJDBCETLTest.class );
    }
    ...
    {	
    	...
    	try {
			 ...
			 * Build the context
			 */
			ApplicationContext context = new FileSystemXmlApplicationContext("example" + File.separator + "writeToJDBC" + File.separator + "writeToJDBC.xml");
